...
public class SistemaSolare {
	...
	public StringBuffer calcoloRotta(CorpoCeleste corpo1, CorpoCeleste corpo2) {
		...
		if(pianeta.getOrbitingMoons().contains(corpo2) && corpo1.getId().charAt(1) != 'S') { // Controlla se il corpo2 sta sulle lune del pianeta, e lo fa solo se il corpo1 non è una stella
