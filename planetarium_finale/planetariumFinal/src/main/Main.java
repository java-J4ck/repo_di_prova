...
public class Main {
	...
	public static void main(String[] args) {
		...
		do 
		{
			System.out.println(visualizzaSisSolare(sistemaSolare));
	...
	private static StringBuffer visualizzaSisSolare(SistemaSolare sis) { // visualizza tutti i pianeti e le rispettive lune
		Stella stella=sis.getStella();
		StringBuffer lista=new StringBuffer(String.format("\n SISTEMA SOLARE %s\n",sis.getName().toUpperCase()));
